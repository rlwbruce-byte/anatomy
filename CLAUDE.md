...
About, `offerings/index.html` and the four offering pages are
currently **Coming Soon splash pages** (`contact.html` is live again): `.page-header` with a `.soon-badge`, then
