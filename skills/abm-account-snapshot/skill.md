...
- **Timing trigger** — the one signal that makes now the right moment to
  engage (funding, leadership change, expansion, renewal window)
- **Stakeholder map** — likely buying committee roles and what each one
  probably cares about
- **Opening angle** — a specific, non-generic reason to reach out this
  account would actually recognize
- **Channel plan** — which 1:1 or 1:few ABM tactics fit this account's size
  and stage (direct mail, exec dinner, personalized landing page, etc.)
